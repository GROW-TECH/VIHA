...
export function Dashboard() {
  ...
  async function fetchStats() {
    try {
      const [clientsRes, designsRes, ordersRes] = await Promise.all([
      ...
      const inProductionCount = ordersRes.data?.filter((o) => o.status === 'In Production').length || 0;
  ...
  return (
    <div className="h-full bg-[#fefefe] p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-gray-900">{stats.inProduction}</div>
      ...
      <div className="bg-white border-2 border-gray-300 rounded-lg p-6 shadow-sm">
        <h2 className="text-xl font-bold text-gray-900 mb-4">Welcome to Viha Sarees Management</h2>
        <p className="text-gray-600 mb-4">
          This is your central hub for managing all aspects of your saree manufacturing business.
        </p>
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start gap-2">
            <span className="text-amber-600 font-bold">•</span>
            <span><strong>Client Register:</strong> Manage all your client details and track balances</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-amber-600 font-bold">•</span>
            <span><strong>Product & Stock:</strong> Maintain your design catalog and stock levels</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-amber-600 font-bold">•</span>
            <span><strong>Production:</strong> Track production orders from issue to completion with waste calculation</span>
          </li>
        </ul>
      </div>
    </div>
